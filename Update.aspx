<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Update.aspx.cs" Inherits="Update" Debug="true" %>
                    ...
                    <div class="col-lg-2 col-sm-4 col-md-3 sidebar" id="sidebar">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="demographic" role="tabpanel" class="tab-pane active" >
                                <br />
                                <br />
                                 <asp:Panel ID="udemo" runat="server">
                                <table>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 486px">
                                            <asp:TextBox ID="patientId" runat="server" Height="30px" Width="200px" CssClass="form-control form-rounded"></asp:TextBox>

                                        </td>
                                        <td class="modal-sm" style="width: 555px">
                                            <asp:TextBox ID="aadharNo" runat="server" Height="30px" Width="200px" CssClass="form-control form-rounded"></asp:TextBox>
                                        </td>
                                    ...
                                    <tr style="color: #0033CC">
                                        <td class="tdFont" style="width: 486px;"><b>First name of Patient 
                                    ...
                                    <tr style="color: #0033CC">
                                        <td class="tdFont" style="width: 486px;">
                                            <asp:TextBox ID="patientFName" runat="server" Height="30px" Width="200px" CssClass="form-control form-rounded" ValidationGroup="demopage"></asp:TextBox>
                                        ...
                                        <td class="tdFont" style="width: 555px; height: 20px; vertical-align: top;">
                                            <asp:TextBox ID="patientMName" runat="server" Height="30px" Width="200px" CssClass="form-control form-rounded"></asp:TextBox>
                                        </td>
                                        <td class="tdFont" style="width: 573px; height: 20px;">
                                            <asp:TextBox ID="patientLName" runat="server" Height="30px" Width="200px" CssClass="form-control form-rounded" ValidationGroup="demopage"></asp:TextBox>
                                    ...
                                    <tr>
                                        <td style="width: 486px"><b class="tdFont">Age</b></td>
                                        <td class="tdFont" style="width: 555px">
                                            Age unit</td>
                                        <td style="width: 573px"><b class="tdFont">Date of Birth</b></td>
                                        <td style="width: 573px" class="tdFont">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style32">
                                            <asp:TextBox ID="patientAge" runat="server" Height="30px" Width="150px" CssClass="form-control form-rounded" ValidationGroup="demopage"></asp:TextBox>
                                        </td>
                                        <td class="auto-style33">
                                            <asp:DropDownList ID="ddAgeUnit" runat="server" Height="30px" Width="180px" CssClass="form-control form-rounded" ValidationGroup="demopage">
                                            ...
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddAgeUnit" InitialValue="0" ErrorMessage="Select one value" Font-Size="XX-Small" ForeColor="Red" ValidationGroup="demopage"></asp:RequiredFieldValidator>
                                                    </td>

                                       
                                                
                                        <td>&nbsp;
                                            <asp:TextBox ID="patientDob" runat="server" Height="30px" Width="200px" AutoComplete="disabled" CssClass="form-control form-rounded"></asp:TextBox>
                                        </td>
                                        <td class="auto-style34">&nbsp;</td>
                                        <td class="auto-style34">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td class="modal-sm" style="width: 555px; height: 20px;">
                                                    <asp:CheckBox ID="ageEstimated" Text="  Estimated" runat="server" Font-Size="Small" CssClass="form-control form-rounded" Width="126px" OnCheckedChanged="ageEstimated_CheckedChanged" />
                                        </td>
                                        <td style="width: 573px; height: 20px;">
                                            &nbsp;</td>
                                        <td style="width: 573px; height: 20px;">
                                    ...
                                    <tr>
                                        ...
                                        <td class="modal-sm" style="width: 555px">
                                            <asp:DropDownList ID="ddOccupationId" runat="server" CssClass="form-control form-rounded" Height="30px" Width="250px" >
                                            </asp:DropDownList>
                                        </td>
                                        <td style="width: 573px">
                                        ...
                                        <div class="col-lg-12" style="top: 0px; left: 2px; margin-top: 0px;">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="col-lg-6" style="text-align: center;">
                                                    <asp:Button ID="resetDemographicBtn" runat="server" Text="Reset" class="btn-danger" Height="35px" Width="75px" OnClick="resetDemographicBtn_Click" />
                                                </div>
                                                <div class="col-lg-6" style="text-align: center;">
                                                    <asp:Button ID="Updatedemo" runat="server" Text="Update &amp; Continue" class="btn-primary" Height="35px" Width="130px" OnClick="UpdateDemo" ValidationGroup="demopage" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4"></div>
...
<!-- /.Injury Page-->
                <div id="injury"  role="tabpanel" class="tab-pane active">
                    <br />
                     <asp:Panel ID="uinjury" runat="server">
               ...
               <tr id="interpersonal4" runat="server">
                   <td style="width: 366px">
                    <asp:DropDownList ID="ddInjuryContext1" runat="server" Height="30px" Width="300px" CssClass="form-control form-rounded" AutoPostBack="True" OnSelectedIndexChanged="ddInjuryContext1_SelectedIndexChanged">
                           <asp:ListItem Selected="True">Select</asp:ListItem>
                   ...
                   <td style="width: 376px">
                    <asp:DropDownList ID="ddInjuryRelationship" runat="server" Height="30px" Width="300px" CssClass="form-control form-rounded" OnSelectedIndexChanged="ddInjuryRelationship_SelectedIndexChanged">
                          <asp:ListItem Selected="True">Select</asp:ListItem>
               ...
               <tr id="interpersonal5" runat="server">
                   <td style="width: 366px">
                    <asp:TextBox ID="otherContextInterPers" runat="server" Height="30px" Width="300px" placeholder="Specify" CssClass="form-control form-rounded" Visible="False"></asp:TextBox>
                   </td>
                   <td style="width: 376px">
                    <asp:TextBox ID="OtherInjuryRelationInterPer" runat="server" Height="30px" Width="300px" placeholder="Specify" CssClass="form-control form-rounded" Visible="False"></asp:TextBox>
                   </td>
                   <td>&nbsp;</td>
               </tr>
               ...
               <tr id="selfdirected4" runat="server">
                   ...
                   <td style="width: 376px">
                    <asp:DropDownList ID="ddInjuryContext2" runat="server" Height="30px" Width="300px" CssClass="form-control form-rounded" OnSelectedIndexChanged="ddInjuryContext2_SelectedIndexChanged">
                    </asp:DropDownList>
                   </td>
                   <td>&nbsp;</td>
               </tr>
               <tr id="selfdirected5" runat="server">
                   <td style="width: 366px">
                       &nbsp;</td>
                   <td style="width: 376px">
                    <asp:TextBox ID="OtherInjuryContetSelf" runat="server" Height="30px" Width="300px" placeholder="Specify" CssClass="form-control form-rounded" Visible="False"></asp:TextBox>
                   </td>
                   <td>&nbsp;</td>
               </tr>
               <tr style="color: #0033CC">
                  ...
                  <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-lg-12" style="top: 0px; left: 2px; margin-top: 0px;">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="col-lg-6" style="text-align: center;">
                                                    <asp:Button ID="resetInjuryBtn" runat="server" Text="Reset" class="btn-danger" Height="35px" Width="75px" OnClick="resetInjuryBtn_Click" />
                                                </div>
                                                <div class="col-lg-6" style="text-align: center;">
                                                    <asp:Button ID="Button4" runat="server" Text="Update &amp; Continue" class="btn-primary" Height="35px" Width="135px" OnClick="SaveInjury" ValidationGroup="injurypage" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4"></div>
                                        </div>
...
<!-- /.Prehospital Page-->
                <div id="prehospital" role="tabpanel" class="tab-pane active ">
                    <br />
                     <asp:Panel ID="uprehospital" runat="server">
                    <table class="nav-justified">
                        <tr style="color: #0033CC">
                                ...
                                <table width="100%">
                                    <tr>
                                        ...
                                        <td class="auto-style49">
                                            <asp:TextBox ID="preInjuryTime" runat="server" CssClass="form-control form-rounded" Height="30px" Width="80px"></asp:TextBox>
                                        </td>
                                        <td>
                                            <asp:DropDownList ID="ddPreInjuryTime" runat="server" Height="30px" >
                                                <asp:ListItem>Months</asp:ListItem>
                                                <asp:ListItem>Days</asp:ListItem>
                                                <asp:ListItem>Hours</asp:ListItem>
                                            </asp:DropDownList>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" style="top: 0px; left: 2px; margin-top: 0px;">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-6" style="text-align: center;">
                                                    <asp:Button ID="SavePrehospital" runat="server" Text="Update &amp; Continue" class="btn-primary" Height="35px" Width="135px" OnClick="Prehospital_Click" ValidationGroup="prepage" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4"></div>
                                        </div>
...
<!-- /.Transfer Data Page-->
                            <div id="transfer" role="tabpanel" class="tab-pane active">
                                ...
                                <br />
                                 <asp:Panel ID="utransfer" runat="server">
                                <table class="nav-justified">
                                    <tr style="color: #0033CC">
                                    ...
                                    <tr id="transferdata" runat="server">
                                            ...
                                            <table>
                                                ...
                                                <tr>
                                                    <td class="auto-style58">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ControlToValidate="transferArrivalDate" ErrorMessage="Field  can't be empty" Font-Size="XX-Small" ForeColor="Red" ValidationGroup="transferpage"></asp:RequiredFieldValidator>
                                                    </td>
                                                    ...
                                                    <td class="auto-style53">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator17" runat="server" ControlToValidate="transferArrivalTime" ErrorMessage="Field  can't be empty" Font-Size="XX-Small" ForeColor="Red" ValidationGroup="transferpage"></asp:RequiredFieldValidator>
                                                    </td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td class="auto-style58">
                                                        ...
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator18" runat="server" ControlToValidate="transferDepartedDate" ErrorMessage="Field  can't be empty" Font-Size="XX-Small" ForeColor="Red" ValidationGroup="transferpage"></asp:RequiredFieldValidator>
                                                    </td>
                                                    <td class="auto-style53">
                                                        <asp:TextBox ID="transferDepartedTime" runat="server" Height="30px" Width="100px" CssClass="form-control form-rounded"></asp:TextBox>
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator19" runat="server" ControlToValidate="transferDepartedTime" ErrorMessage="Field  can't be empty" Font-Size="XX-Small" ForeColor="Red" ValidationGroup="transferpage"></asp:RequiredFieldValidator>
                                                    </td>
                                                    <td>&nbsp;</td>
                                                </tr>
                                                <tr>
                                        ...
                                        <table id ="transferdata2" runat="server">
                                                ...
                                                <tr>
                                                    <td>&nbsp;</td>
                                                    <td >
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator20" runat="server" ControlToValidate="transferVitalsAtDate" ErrorMessage="Field  can't be empty" Font-Size="XX-Small" ForeColor="Red" ValidationGroup="transferpage"></asp:RequiredFieldValidator>
                                                    </td>
                                                    <td >
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator21" runat="server" ControlToValidate="transferVitalsAtTime" ErrorMessage="Field  can't be empty" Font-Size="XX-Small" ForeColor="Red" ValidationGroup="transferpage"></asp:RequiredFieldValidator>
                                                    </td>
                                                    <td></td>
                                                     <td></td>
                                                     <td></td>
                                            ...
                                            <tr>
                                                ...
                                                <td style="vertical-align: top"><asp:DropDownList ID="ddTransferTemp" runat="server" CssClass="form-control form-rounded" Height="30px">
                                            ...
                                            <tr>
                                                    <td>&nbsp;</td>
                                                    <td >
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator22" runat="server" ControlToValidate="transferGCSAtDate" ErrorMessage="Field  can't be empty" Font-Size="XX-Small" ForeColor="Red" ValidationGroup="transferpage"></asp:RequiredFieldValidator>
                                                    </td>
                                                    <td >
                                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator23" runat="server" ControlToValidate="transferGCSAtTime" ErrorMessage="Field  can't be empty" Font-Size="XX-Small" ForeColor="Red" ValidationGroup="transferpage"></asp:RequiredFieldValidator>
                                                    </td>
                                                    <td></td>
                                                     <td></td>
                                                     <td></td>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" style="top: 0px; left: 2px; margin-top: 0px;">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-6" style="text-align: center;">
                                                    <asp:Button ID="TransferSave" runat="server" Text="Update &amp; Continue" class="btn-primary" Height="35px" Width="130px" OnClick="SaveTransfer" ValidationGroup="transferpage" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4"></div>
                                        </div>
...
<!-- /.Emergency Data Page-->
                             <div id="emergency" role="tabpanel" class="tab-pane active">
                                <h3 style="text-align:center">&nbsp;&nbsp;</h3>
                                  <asp:Panel ID="uemergency" runat="server">
                                <table class="nav-justified">
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td class="tdFont">First spont. Resp rate</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 368px">
                                    ...
                                    <tr>
                                        <td style="width: 500px"><table><tr>
                                                <td class="auto-style60"><b style="font-size: small;color:red">GCS At- </b>&nbsp;&nbsp;</td>
                                            <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="vertical-align: top">
                                            <asp:DropDownList ID="ddEmergencyDischargeDisposition" runat="server" Width="200px" Height="30px" CssClass="form-control form-rounded">
                                            </asp:DropDownList>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-lg-12" style="top: 0px; left: 2px; margin-top: 0px;">
                                            <div class="col-lg-4"></div>
                                            <div class="col-lg-4">
                                                <div class="col-lg-6" style="text-align: center; height: 35px;">
                                                ...
                                                <div class="col-lg-6" style="text-align: center;">
                                                    <asp:Button ID="Button10" runat="server" Text="Update &amp; Continue" class="btn-primary" Height="35px" Width="135px" OnClick="SaveEmergency" ValidationGroup="emergency" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4"></div>
                                        </div>
...
<!-- /.Operation Page-->
                            <div id="operation" role="tabpanel" class="tab-pane active" >
                                <h3 style="text-align:center">&nbsp;&nbsp;</h3>
                                 <asp:Panel ID="uoperation" runat="server">
                                <table  class="nav-justified">
                                    <tr>
                                ...
                                <table id="operationtable" runat="server" class="nav-justified">
                                    ...
                                    <tr  >
                                        <td class="modal-sm" style="width: 70px">&nbsp;</td>
                                        <td style="width: 345px">
                                            <asp:Button ID="btnOperationAdd" runat="server" BackColor="#5DBCD2" CssClass="form-control form-rounded" Font-Bold="True" OnClick="btnOperationAdd_Click" Text="Add" Width="60px" />
                                        </td>
                                        <td style="width: 317px">&nbsp;</td>
                                        <td>
                                            &nbsp;</td>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" style="top: 0px; left: 2px; margin-top: 0px;">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-6" style="text-align: center;">
                                                    <asp:Button ID="SaveOperation" runat="server" Text="Update &amp; Continue" class="btn-primary" Height="35px" Width="135px" OnClick="SaveOperationData" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4"></div>
                                        </div>
...
<!-- /.Diagnosis Page-->
                            <div id="diagnosis" role="tabpanel" class="tab-pane active" >
                                <h3 style="text-align:center">&nbsp;</h3>
                                 <asp:Panel ID="udiagnosis" runat="server">
                                <table class="nav-justified">
                                    <tr style="color: #0033CC">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 208px">&nbsp;</td>
                                        <td>
                                            <asp:Button ID="btnDiagnosisAdd" runat="server" BackColor="#5DBCD2" CssClass="form-control form-rounded" Font-Bold="True" OnClick="btnDiagnosisAdd_Click" Text="Add" Width="60px" />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="auto-style31">&nbsp;</td>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" style="top: 0px; left: 2px; margin-top: 0px;">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-6" style="text-align: center;">
                                                    <asp:Button ID="Button14" runat="server" Text="Update &amp; Continue" class="btn-primary" Height="35px" Width="135px" OnClick="SaveDiagnosisData" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4"></div>
                                        </div>
...
<!-- /.Outcome Page class="tab-pane fade"-->
                            <div id="outcome" role="tabpanel" class="tab-pane active">
                                <h3 style="text-align:center">&nbsp;&nbsp;&nbsp;</h3>
                                 <asp:Panel ID="uoutcome" runat="server">
                                <table class="nav-justified">
                                    
                                    <tr>
                                        <td class="tdFont">Date and time of</td>
                                        <td class="tdFont" >
                                            <asp:DropDownList ID="ddOutcome" runat="server" Height="30px" Width="150px" CssClass="form-control form-rounded" OnSelectedIndexChanged="ddOutcome_SelectedIndexChanged">
                                        ...
                                        <td style="height: 20px; width: 417px">
                                            &nbsp;</td>
                                        <td style="height: 20px">
                                            &nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="modal-sm" style="height: 20px; width: 373px"></td>
                                        <td class="modal-sm" style="height: 20px; width: 373px">&nbsp;</td>
                                        <td class="auto-style65"></td>
                                        <td style="height: 20px"></td>
                                    </tr>
                                    <tr style="color: #0033CC">
                                        <td class="tdFont" style="height: 20px; width: 373px; font-weight: bold">Total hospital durationion</td>
                                        <td class="tdFont" style="height: 20px; width: 373px; font-weight: bold"><b class="tdFont">Total ICU days</b></td>
                                        <td class="auto-style65"><b class="tdFont">Total ventilator days</b></td>
                                        <td style="height: 20px">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="modal-sm" style="width: 373px">&nbsp;</td>
                                        <td class="modal-sm" style="width: 373px">&nbsp;</td>
                                        <td class="auto-style64">&nbsp;</td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="modal-sm" style="width: 373px">
                                            <table>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td style="vertical-align: top">
                                                        <asp:DropDownList ID="hospitalduration2" runat="server" CssClass="form-control form-rounded" Height="28px">
                                                            <asp:ListItem>Hours</asp:ListItem>
                                                            <asp:ListItem>Days</asp:ListItem>
                                    ...
                                    <tr>
                                        <td class="modal-sm" style="width: 373px; height: 20px; color: #FF0000"><strong>Blood transfusion</strong></td>
                                        <td class="modal-sm" style="width: 373px; height: 20px; color: #FF0000">&nbsp;</td>
                                        <td class="auto-style65"></td>
                                        <td style="height: 20px"></td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        <td style="width: 373px; " class="tdFont">Discharge disposition</td>
                                        <td style="width: 373px; " class="tdFont">&nbsp;</td>
                                        <td class="auto-style64"><span style="color: #0033CC"><b class="tdFont">Complication</b></span></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="modal-sm" style="width: 373px">
                                            <asp:DropDownList ID="ddOutcomeDischargeDisposition" runat="server" Height="30px" Width="200px" CssClass="form-control form-rounded">
                                            </asp:DropDownList>
                                        </td>
                                        <td class="modal-sm" style="width: 373px">
                                            &nbsp;</td>
                                    ...
                                    <tr>
                                        <td class="modal-sm" style="width: 373px">
                                            <asp:TextBox ID="outcomeOtherDisposition" runat="server" Height="30px" Width="300px" CssClass="form-control form-rounded" Visible="False"></asp:TextBox>
                                        </td>
                                        <td class="modal-sm" style="width: 373px">&nbsp;</td>
                                        <td class="auto-style64">&nbsp;</td>
                                        <td>&nbsp;</td>
                                    ...
                                    <tr>
                                        <td class="modal-sm" style="width: 373px; height: 20px; color: #FF0000"><strong>Discharge/Transfer GCS</strong></td>
                                        <td class="modal-sm" style="width: 373px; height: 20px; color: #FF0000">&nbsp;</td>
                                        <td class="auto-style65"></td>
                                        <td style="height: 20px"></td>
                                    </tr>
                                    ...
                                    <tr style="color: #0033CC">
                                        <td class="tdFont" style="width: 373px; height: 20px; font-weight: bold">Eye opening</td>
                                        <td class="tdFont" style="width: 373px; height: 20px; font-weight: bold">&nbsp;</td>
                                        <td class="auto-style65"><b class="tdFont">Verbal Response</b></td>
                                        <td style="height: 20px"><b class="tdFont">Motor response</b></td>
                                        <td class="tdFont">Total</td>
                                    </tr>
                                    <tr>
                                        <td class="modal-sm" style="width: 373px">
                                                                    <asp:DropDownList ID="ddOutcomeEye" runat="server" CssClass="form-control form-rounded" Width="150px">
                                                                        <asp:ListItem Value="4">4 Spontaneous</asp:ListItem>
                                                                        <asp:ListItem Value="3">3 To Voice</asp:ListItem>
                                                                        <asp:ListItem Value="2">2 To Pain</asp:ListItem>
                                                                        <asp:ListItem Value="1">1 None</asp:ListItem>
                                    ...
                                    <tr style="color: #0033CC">
                                        <td class="tdFont" style="width: 373px; font-weight: bold">Glasgow Outcome Scale</td>
                                        <td class="tdFont" style="width: 373px; font-weight: bold">&nbsp;</td>
                                        <td class="auto-style64"><b class="tdFont">Consults</b></td>
                                        <td>&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="modal-sm" style="width: 373px">
                                    ...
                                    <tr>
                                        <td class="modal-sm" style="width: 373px; height: 20px"></td>
                                        <td class="modal-sm" style="width: 373px; height: 20px">&nbsp;</td>
                                        <td class="auto-style65"></td>
                                        <td style="height: 20px"></td>
                                    </tr>
                                    <tr>
                                        <td class="modal-sm" style="width: 373px; height: 20px"><b class="tdFont">Brain death before expiring</b></td>
                                        <td class="modal-sm" style="width: 373px; height: 20px">&nbsp;</td>
                                        <td class="auto-style63">Life support withdrawn</td>
                                        <td style="height: 20px">&nbsp;</td>
                                    </tr>
                                    <tr>
                                        <td class="modal-sm" style="width: 373px; height: 20px">
                                    ...
                                    <tr>
                                        ...
                                        <td class="modal-sm" style="width: 373px">
                                            &nbsp;</td>
                                        <td id="organs1" runat="server" class="auto-style64">
                                    ...
                                    <tr>
                                        ...
                                        <td class="modal-sm" style="width: 373px">&nbsp;</td>
                                        <td id="organs2" runat="server" class="auto-style64">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12" style="top: 0px; left: 2px; margin-top: 0px;">
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <div class="col-lg-6" style="text-align: center;">
                                                    <asp:Button ID="SaveOutcome" runat="server" Text="Update &amp; Continue" class="btn-primary" Height="35px" Width="130px" OnClick="SaveOutcomeData" ValidationGroup="outcome" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4"></div>
                                        </div>
...
<!-- /.Finance Page-->
                            <div id="finance"  role="tabpanel" class="tab-pane active">
                                <h3 style="text-align:center"></h3>
                                 <asp:Panel ID="ufinance" runat="server">
                                <table class="nav-justified">
                                    <tr style="color: #0033CC">
                                        <td class="tdFont" style="width: 342px; font-weight: bold">Financial Information Availableble</td>
                                    ...
                                    <tr id="finance4" runat="server">
                                        ...
                                        <td style="width: 364px">
                                            <asp:TextBox ID="totalReimburishment" runat="server" Height="30px" Width="149px" CssClass="form-control form-rounded"></asp:TextBox>
                                            <br />
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        <div class="col-lg-12" style="top: 0px; left: 2px; margin-top: 0px;">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="col-lg-6" style="text-align: center;">
                                                    <asp:Button ID="resetFinanceBtn" runat="server" Text="Reset" class="btn-danger" Height="35px" Width="75px" OnClick="resetFinanceBtn_Click" />
                                                </div>
                                                <div class="col-lg-6" style="text-align: center;">
                                                    <asp:Button ID="Button18" runat="server" Text="Update" class="btn-primary" Height="35px" Width="119px" OnClick="Button2_Click" ValidationGroup="financial" />
                                                </div>
                                            </div>
                                            <div class="col-lg-4"></div>
                                        </div>
